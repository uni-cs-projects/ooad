<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="WebApplication6.WebForm8" %>
<!DOCTYPE html>
        ...
        <form runat="server">
            ...
            <div class="form-group" >
                <div class="input-group">
                    ...
                    <input type="text" id="usrname" runat="server" class="form-control" name="username" placeholder="Username" required="required" />
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-at"></i></span>
                    <input type="email" id="email" runat="server" class="form-control" name="email" placeholder="Email" required="required" />
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
            ...
            <div class="form-group">
               <asp:Button ID="Button1" runat="server" Text="Register" type="submit" class="btn btn-success btn-block login-btn" OnClick="Button1_Click" />
            </div>

        </form>
        <div class="hint-text small">Already have an account? <a href="login.aspx" class="text-success">Signin</a></div>
    </div>
